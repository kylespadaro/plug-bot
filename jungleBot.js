    ...
    */
    ...
    var jungleBot = {
        ...
        botName: 'JungleBot',
  			...
  			intervalMessages: ["The RCS Extension is an enhancement for plug.dj. Install it to use emotes and for a bunch of other cool features! https://rcs.radiant.dj", "Connect with xQc: Stream: http://twitch.tv/xqcow Twitter: https://twitter.com/xqc YouTube: http://youtube.com/xqcow  Reddit: https://www.reddit.com/r/xqcow Discord: http://discord.gg/xqcow (you don't have to be a sub)", "Don't know how to play your song? Check here: http://bit.ly/jungle-dj-help", "Here's a few useful (and not so useful) commands everyone can use: https://git.io/fN5eb#bot-commands", "Vote for the plug DJ MVP with !mvp @user :PogU:", "!rankings"],
  			messageInterval: 11,
  			songstats: false,
  			commandLiteral: '?',
  			blacklists: {
        ...
        room: {
            ...
            roulette: {
                ...
                startRoulette: function() {
                    ...
                    API.sendChat('/me  @RCS @djs | ' + jungleBot.chat.isopen);
                },
        ...
        roomUtilities: {
            ...
            eventUserjoin: function(user) {
                ...
                if (user.id == 37147238) {
                API.sendChat("!smon");
                setTimeout(function() { API.sendChat("!b+");}, 1000);
	...
	// START OF COMMANDS
                             ...
                             functionality: function(chat, cmd) {
                               ...
                               var cmdmsg = msg.substr(cmd.length + 1);
                                 ...
                                 if (!jungleBot.commands.executable(this.rank, chat)) return void(0);
                                            ...
                                            API.sendChat(cmdmsg + ' https://i.imgur.com/GyHvism.gif');
                                 }
                             }
                         },
                             ...
                             functionality: function(chat, cmd) {
                               ...
                               var cmdmsg = msg.substr(cmd.length + 1);
                                 ...
                                 if (!jungleBot.commands.executable(this.rank, chat)) return void(0);
                                            ...
                                            API.sendChat('/me ' + cmdmsg + ' You can find starter help here: http://bit.ly/xqcs-jungle#how-can-i-dj');
                                 }
                             }
                         },
                             ...
                             functionality: function(chat, cmd) {
                               ...
                               var cmdmsg = msg.substr(cmd.length + 1);
                                 ...
                                 if (!jungleBot.commands.executable(this.rank, chat)) return void(0);
                                            ...
                                            API.sendChat(' @rustyimpact :WeirdChamp: https://www.youtube.com/watch?v=pY0frOnErzg');
                                 }
                             }
                         },
	   ...
	   //(formerly scuffed) afk command
            ...
            afkCommand: {
                ...
                functionality: function(chat, cmd) {
                    ...
                    if (!jungleBot.commands.executable(this.rank, chat)) return void(0);
                        ...
                        API.sendChat('/me @' + chat.un + ' is now AFK :ppPoof: ');
      		          }
      		      }
      	    },
        	...
        	//ricardoFlick
                  ...
                  flickCommand: {
                             command: ['flick', 'ricardo', 'ricardoflick'],
                             rank: 'user',
                             type: 'startsWith',
                             functionality: function(chat, cmd) {
                               ...
                               var cmdmsg = msg.substr(cmd.length + 1);
                                 ...
                                 if (!jungleBot.commands.executable(this.rank, chat)) return void(0);
                                            ...
                                            API.sendChat(cmdmsg + ' https://i.imgur.com/5KQrG07.gif');
                                 }
                             }
                         },
          ...
          mvpRankingCommand:  {
                   command: ['mvpranking', 'mvprankings', 'ranking', 'rankings'],
                   rank: 'residentdj',
                   type: 'startsWith',
                   functionality: function(chat, cmd) {
                                var ranknumber = 5;
        	...
        	emotesCommand: {
                        ...
                        functionality: function(chat, cmd) {
                            ...
                            if (!jungleBot.commands.executable(this.rank, chat)) return void(0);
        	                       ...
        	                       API.sendChat('/me ' + cmdmsg + ' We recommend the RCS Extension for emotes. When you have RCS installed, type emotes using colons, like :this: | Get RCS here: https://git.io/fN5eb#rcs-extension');
                             }
                          }
                      },
		 ...
		 jojoCommand: {
                    ...
                    functionality: function (chat, cmd) {
                      ...
                      if (!jungleBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        API.sendChat("/me 'If you play Jojo, I will skip it, and permaban your dumbass' - xQc 2019");
                      }
                    }
                  },
